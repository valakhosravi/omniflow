...
import { useGetAllUserNotifionQuery } from "@/packages/features/task-inbox/api/NotificationApi";
import { useDispatch } from "react-redux";
import NotificationDetailModal from "@/packages/features/notification/components/NotificationDetailModal";
import {
...
export default function NotificationDropdown() {
  ...
  const { data: unReadNotifications } = useGetAllUserNotifionQuery(false);
