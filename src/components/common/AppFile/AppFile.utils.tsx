...
export const getFileIcon = (fileType: string, fileName: string) => {
  ...
  if (!fileType)
    return <AppIcon name="Document" size={32} className="text-primary-950/[.2]" />;
  if (fileType.includes("pdf"))
    return <AppIcon name="DocumentText" size={32} />;
  if (fileType.includes("presentation") || fileType.includes("powerpoint"))
    return <AppIcon name="PresentionChart" size={32} className="text-orange-500" />;
  if (fileType.includes("word") || fileType.includes("document"))
    return <AppIcon name="DocumentText1" size={32} />;
  if (
    fileType.includes("zip") ||
    fileType.includes("rar") ||
    ext === "zip" ||
    ...
    return <AppIcon name="ArchiveBox" size={32} />;
  return <AppIcon name="Image" size={32} className="text-primary-950/[.2]" />;
};
