import { RequestDetailProps } from "./AppRequestDetails.type";
import ApplicantDetail from "./Components/AppRequestDetailContent";
import AppRequestDetailReview from "./Components/AppRequestDetailsReview";
...
export default function AppRequestDetail({
  ...
  return (
    <div className="col-span-4 space-y-3 sticky top-4 self-start">
      <AppRequestDetailReview reviewOfUnits={reviewOfUnits ?? false} />
      {applicantDetail && applicantData && (
        <ApplicantDetail applicantData={applicantData} />
      )}
      <div className="border border-neutral-200 rounded-[20px] p-4">
