...
// import { useGetLastRequestStatusQuery, useGetRequestTimelineQuery } from "@/services/commonApi/commonApi";
// import { STATUS_STYLES } from "@/components/common/AppRequestDetails/AppRequestDetails.const";
// import WarehouseDescription from "../v1/components/WarehouseDescription";

// export default function WarehouseCheckIndex({
//   requestId,
// }: {
//   formKey: string;
//   requestId: string;
...
//     });
//   const { data: requestStatus, refetch } = useGetLastRequestStatusQuery(Number(requestId), {
//     skip: !requestId,
//     refetchOnMountOrArgChange: true,
//   });
