...
// import ReferralModalSecondAudit from "./ReferralModalSecondAudit";
// import { addToaster } from "@/ui/Toaster";
// import { getInvoiceByRequestId } from "../invoice.type";
// import { useGetRejectionReasonsQuery } from "../Invoice.services";

// interface SecondAuditAdditionalDescriptionProps {
//   title: string;
...
// export default function SecondAuditAdditionalDescription({
//   title,
//   invoiceDetails,
// }: SecondAuditAdditionalDescriptionProps) {
//   const searchParams = useSearchParams();
//   const router = useRouter();
//   const taskId = searchParams?.get("taskId");
//   const [, setIsAcceptingRequest] = useState(false);
...
//   const [submittedData] = useState<FormValues | null>(null);
...
//         SecondAuditApprove: true,
//         SecondAuditDescription: managerDescription,
...
//   const handletreasury = handleSubmit(async (data: FormValues) => {
//     if (!taskId) return;
//     if (!managerDescription.trim()) {
//       setManagerRejectDescriptionError(true);
//       return;
...
//               وضعیت پرداخت <span className="text-accent-500">*</span>
//             </div>
//             <Controller
//               name="paymentMethod"
//               control={control}
