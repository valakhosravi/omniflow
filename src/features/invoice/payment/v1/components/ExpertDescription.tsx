...
// import ExpertAdditionalDescription from "./ExpertAdditionalDescription";
...
// export default function ExpertDescription({
//   invoiceDetails,
//   requestId,
// }: ExpertDescriptionProps) {
