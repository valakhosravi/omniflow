...
export const supportExpertBugStatus = {
  [SupportExpertEnum.FIXED]: 1,
  [SupportExpertEnum.NEED_USER_ACTION]: 2,
  [SupportExpertEnum.NOT_FIXED]: 2,
};
export const userVerifyBugStatus = {
  [UserReviewEnum.FIXED]: 1,
  [UserReviewEnum.NOT_FIXED]: 2,
};
