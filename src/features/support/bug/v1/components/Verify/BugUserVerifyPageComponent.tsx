...
import { useBugUserVerifyWorkflow } from "../../hooks/useBugUserVerifyWorkflow";
import BugReviewDetails from "../BugReviewDetails";

function BugUserVerifyPageComponent() {
  const wf = useBugUserVerifyWorkflow();
...
export default AppWithTaskInboxSidebar(BugUserVerifyPageComponent);
