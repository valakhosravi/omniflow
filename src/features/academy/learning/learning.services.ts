...
const LEARNING_API_BASE = "/v1/Academy/Learning";
  ...
  endpoints: (builder) => ({
    ...
    getAllCategories: builder.query<GeneralResponse<CategoryDto[]>, void>({
      queryFn: async (_arg, _api, _opts, baseQuery) => {
        ...
        return baseQuery({
          url: `${LEARNING_API_BASE}/Category/GetAll`,
          method: "GET",
        }) as any;
      },
    ...
    searchCategories: builder.query<GeneralResponse<CategoryDto[]>, string>({
      queryFn: async (value, _api, _opts, baseQuery) => {
        ...
        return baseQuery({
          url: `${LEARNING_API_BASE}/Category/Search`,
          method: "GET",
          params: { value },
        }) as any;
      },
    ...
    getAllCourses: builder.query<GeneralResponse<CourseDto[]>, void>({
      queryFn: async (_arg, _api, _opts, baseQuery) => {
        ...
        return baseQuery({
          url: `${LEARNING_API_BASE}/Course/GetAll`,
          method: "GET",
        }) as any;
      },
      providesTags: ["Course"],
    ...
    getCourseById: builder.query<GeneralResponse<CourseDto>, number>({
      queryFn: async (id, _api, _opts, baseQuery) => {
        ...
        return baseQuery({
          url: `${LEARNING_API_BASE}/Course/GetById/${id}`,
          method: "GET",
        }) as any;
      },
    ...
    >({
      queryFn: async (data, _api, _opts, baseQuery) => {
        ...
        return baseQuery({
          url: `${LEARNING_API_BASE}/Course/Create`,
          method: "POST",
    ...
    >({
      queryFn: async ({ id, body }, _api, _opts, baseQuery) => {
        ...
        return baseQuery({
          url: `${LEARNING_API_BASE}/Course/Update/${id}`,
          method: "PUT",
    ...
    deleteCourse: builder.mutation<GeneralResponse<null>, number>({
      queryFn: async (id, _api, _opts, baseQuery) => {
        ...
        return baseQuery({
          url: `${LEARNING_API_BASE}/Course/Delete/${id}`,
          method: "DELETE",
        }) as any;
      },
      invalidatesTags: ["Course"],
    ...
    changeCourseStatus: builder.mutation<GeneralResponse<null>, number>({
      queryFn: async (id, _api, _opts, baseQuery) => {
        ...
        return baseQuery({
          url: `${LEARNING_API_BASE}/Course/ChangeStatus/${id}`,
          method: "PATCH",
        }) as any;
      },
      invalidatesTags: (_result, _error, id) => [
    ...
    getSeasonById: builder.query<GeneralResponse<SeasonDto>, number>({
      queryFn: async (id, _api, _opts, baseQuery) => {
        ...
        return baseQuery({
          url: `${LEARNING_API_BASE}/Season/GetById/${id}`,
          method: "GET",
        }) as any;
      },
    ...
    >({
      queryFn: async (courseId, _api, _opts, baseQuery) => {
        ...
        return baseQuery({
          url: `${LEARNING_API_BASE}/Season/GetAllByCourseId`,
          method: "GET",
          params: { courseId },
        }) as any;
      },
    ...
    >({
      queryFn: async (body, _api, _opts, baseQuery) => {
        ...
        return baseQuery({
          url: `${LEARNING_API_BASE}/Season/Create`,
          method: "POST",
          body,
        }) as any;
      },
    ...
    >({
      queryFn: async ({ id, body }, _api, _opts, baseQuery) => {
        ...
        return baseQuery({
          url: `${LEARNING_API_BASE}/Season/Update/${id}`,
          method: "PUT",
          body,
        }) as any;
      },
    ...
    deleteSeason: builder.mutation<GeneralResponse<null>, number>({
      queryFn: async (id, _api, _opts, baseQuery) => {
        ...
        return baseQuery({
          url: `${LEARNING_API_BASE}/Season/Delete/${id}`,
          method: "DELETE",
        }) as any;
      },
      invalidatesTags: ["Season"],
    ...
    >({
      queryFn: async (body, _api, _opts, baseQuery) => {
        ...
        return baseQuery({
          url: `${LEARNING_API_BASE}/Season/ChangeOrder`,
          method: "PUT",
          body,
        }) as any;
      },
    ...
    getSectionById: builder.query<GeneralResponse<SectionDto>, number>({
      queryFn: async (id, _api, _opts, baseQuery) => {
        ...
        return baseQuery({
          url: `${LEARNING_API_BASE}/Section/GetById/${id}`,
          method: "GET",
        }) as any;
      },
    ...
    >({
      queryFn: async (seasonId, _api, _opts, baseQuery) => {
        ...
        return baseQuery({
          url: `${LEARNING_API_BASE}/Section/GetBySeasonId`,
          method: "GET",
          params: { seasonId },
        }) as any;
      },
    ...
    >({
      queryFn: async (body, _api, _opts, baseQuery) => {
        ...
        return baseQuery({
          url: `${LEARNING_API_BASE}/Section/Create`,
          method: "POST",
          body,
        }) as any;
      },
    ...
    >({
      queryFn: async ({ id, body }, _api, _opts, baseQuery) => {
        ...
        return baseQuery({
          url: `${LEARNING_API_BASE}/Section/Update/${id}`,
          method: "PUT",
          body,
        }) as any;
      },
    ...
    deleteSection: builder.mutation<GeneralResponse<null>, number>({
      queryFn: async (id, _api, _opts, baseQuery) => {
        ...
        return baseQuery({
          url: `${LEARNING_API_BASE}/Section/Delete/${id}`,
          method: "DELETE",
        }) as any;
      },
      invalidatesTags: ["Section"],
    ...
    >({
      queryFn: async (data, _api, _opts, baseQuery) => {
        ...
        return baseQuery({
          url: `${LEARNING_API_BASE}/Section/CreateAndUploadFile`,
          method: "POST",
          body: toFormData(data as unknown as Record<string, unknown>),
        }) as any;
      },
    ...
    getAllTeachers: builder.query<GeneralResponse<TeacherDto[]>, void>({
      queryFn: async (_arg, _api, _opts, baseQuery) => {
        ...
        return baseQuery({
          url: `${LEARNING_API_BASE}/Teacher/GetAll`,
          method: "GET",
        }) as any;
      },
    ...
    searchTeachers: builder.query<GeneralResponse<TeacherDto[]>, string>({
      queryFn: async (value, _api, _opts, baseQuery) => {
        ...
        return baseQuery({
          url: `${LEARNING_API_BASE}/Teacher/Search`,
          method: "GET",
          params: { value },
        }) as any;
      },
    ...
    getTeacherById: builder.query<GeneralResponse<TeacherDto>, number>({
      queryFn: async (id, _api, _opts, baseQuery) => {
        ...
        return baseQuery({
          url: `${LEARNING_API_BASE}/Teacher/GetById/${id}`,
          method: "GET",
        }) as any;
      },
    ...
    >({
      queryFn: async (body, _api, _opts, baseQuery) => {
        ...
        return baseQuery({
          url: `${LEARNING_API_BASE}/Teacher/Create`,
          method: "POST",
          body: toFormData(body as unknown as Record<string, unknown>),
        }) as any;
      },
    ...
    >({
      queryFn: async ({ id, body }, _api, _opts, baseQuery) => {
        ...
        return baseQuery({
          url: `${LEARNING_API_BASE}/Teacher/Update/${id}`,
          method: "PUT",
          body: toFormData(body as unknown as Record<string, unknown>),
        }) as any;
      },
    ...
    deleteTeacher: builder.mutation<GeneralResponse<null>, number>({
      queryFn: async (id, _api, _opts, baseQuery) => {
        ...
        return baseQuery({
          url: `${LEARNING_API_BASE}/Teacher/Delete/${id}`,
          method: "DELETE",
        }) as any;
      },
      invalidatesTags: ["Teacher"],
