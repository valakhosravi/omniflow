          ...
          {showConfirmation ? (
              ...
              <div className="flex items-center gap-3 p-4 bg-warning-50 border border-warning-200 rounded-[12px]">
                ...
                <div className="flex-1">
                  ...
                  <p className="text-[14px] text-primary-950/[.7]">
                    با بارگذاری این قالب، تمام مواد، بندها و تبصره‌های موجود در
                    قرارداد شما حذف شده و با محتوای قالب جایگزین می‌شود. آیا از
                    ادامه مطمئن هستید؟
                  </p>
                </div>
              </div>
            ...
            <div className="space-y-4 py-4">
              <p className="text-[14px] text-primary-950/[.7] mb-4">
                دسته‌بندی را انتخاب کنید و سپس زیردسته‌بندی مورد نظر را برای
                بارگذاری قالب انتخاب کنید.
              </p>
              ...
              <div className="space-y-4">
                ...
                <div>
                  ...
                  <Select
                    ...
                    classNames={{
                      trigger:
                        "bg-white border border-default-300 rounded-[12px] shadow-none h-[56px] min-h-[56px]",
                  ...
                  <div>
                    ...
                    {isLoadingSubCategories ? (
                      <div className="flex items-center justify-center py-4">
                        <div className="text-[14px] text-primary-950/[.7]">
                          در حال بارگذاری...
                        </div>
                      </div>
