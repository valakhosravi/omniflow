...
import { SaveTemplateWithFieldsFormData } from "../../../contract.types";
import { useContractCategories } from "../../../hook/contractHook";
import { useUpdateSubCategoryWithFieldsMutation } from "../../../contract.services";
...
export default function SaveTemplateWithFieldsModal({
  ...
  const onSubmit = async (data: TemplateFormData) => {
    ...
    if (!isUpdateMode) {
      router.push(
        `/issue/contract/personal-template/create?categoryId=${data.CategoryId}`,
      );
    }
  };
