...
import { GetContractInfo, TermDetails } from "../../contract.types";
import { useEffect, useState, useRef } from "react";
import JoditEditor from "jodit-react";

type IJodit = React.ComponentRef<typeof JoditEditor>;
import { useUpdateFullTermRequestMutation } from "../../contract.services";
import {
  BaseQueryFn,
  FetchBaseQueryError,
...
export default function LmcEditTermModal({
  ...
  const { handleSubmit, reset } = useForm<EditTermFormData>();
  ...
  const subClauseEditorContainerRefs = useRef<Map<number, HTMLDivElement>>(
    new Map(),
  );
                  ...
                  return (
                    ...
                    >
                      <div className="flex items-center justify-between">
                        ...
                        <CustomButton
                          ...
                          onPress={() => {
                            ...
                            subClauseEditorContainerRefs.current.delete(
                              subClauseId,
                            );
                            handleDelete(sIndex);
                          }}
                      ...
                      <div
                        ref={(el) => {
                          if (el) {
                            subClauseEditorContainerRefs.current.set(
                              subClauseId,
                              el,
                            );
                          }
                      ...
                      >
                        <JoditEditor
                          ...
                          editorRef={(editor) => {
                            if (editor) {
                              subClauseEditorRefs.current.set(
                                subClauseId,
                                editor,
                              );
                              setTimeout(() => {
