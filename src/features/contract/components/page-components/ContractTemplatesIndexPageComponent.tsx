...
import { useDeleteSubCategoryTemplateMutation } from "../../contract.services";
...
const breadcrumbs: BreadcrumbsItem[] = [
  { Name: "خانه", Href: "/" },
  { Name: "قراردادهای تیپ", Href: "/issue/contract/templates" },
];

export default function ContractTemplatesIndexPageComponent() {
  ...
  const handleCreate = () => {
    router.push("/issue/contract/templates/create");
  };
  ...
  const handleEdit = (subCategoryId: number) => {
    ...
    if (subCategory) {
      ...
      router.push(
        `/issue/contract/templates/update?${searchParams.toString()}`,
      );
    }
  };
    ...
    <>
      <div className="container mx-auto">
        ...
        <div className="flex justify-between items-center mb-6">
          <StartProcessHeader title="لیست قرارداد های تیپ" />
          <CustomButton
