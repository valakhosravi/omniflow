...
import {
  setContractId,
  setContractTitle as setcontractTitle,
  setFormData,
} from "../../contract.slices";
import { FieldValueDetailsModel } from "../../contract.types";
    ...
    fullEditContract({
      ...
      .then((res) => {
        if (res?.ResponseCode === 100) {
          ...
          router.push(
            `/issue/contract/type/preview?edit=true&categoryId=${contractInfo.Data?.CategoryId}&contractId=${contractInfo.Data?.ContractId}&taskId=${taskId}`,
          );
        } else {
          addToaster({
