...
export function buildSalaryDeductionPrintHtml(data: SalaryDeductionPrintData) {
  const trackingCode = escapeHtml(data.trackingCode || "—");
  const createdDate = escapeHtml(data.createdDate || "—");
  const fullName = escapeHtml(data.fullName || "....................");
  const fatherName = escapeHtml(data.fatherName || "....................");
  const nationalCode = escapeHtml(data.nationalCode || "....................");
  const personnelId = escapeHtml(data.personnelId || "....................");
  const guaranteeFullName = escapeHtml(
    data.guaranteeFullName || "....................",
  );
  const amount = escapeHtml(data.amount || "....................");
  const installmentAmount = escapeHtml(
