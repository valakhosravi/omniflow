...
import { useDevelopmentManagerWorkflow } from "../hooks/useDevelopmentManagerWorkflow";
import DevelopmentReviewDetails from "./DevelopmentReviewDetails";

function DevelopmentManagerPageComponent() {
  const wf = useDevelopmentManagerWorkflow();
...
export default AppWithTaskInboxSidebar(DevelopmentManagerPageComponent);
