...
function OrderSummaryContent() {
  ...
  const { planOrderSummary, isGetting } = useGetPlanOrderSummary(planId, debouncedSearchTerm || undefined);
        ...
        <div className="max-h-[500px] overflow-y-auto">
          <Table
            ...
            classNames={{
              ...
              thead: "h-auto",
              wrapper: "p-0",
              table: "border-separate border-spacing-0 border border-secondary-100 rounded-[12px]",
            }}
            shadow="none"
            isStriped
          >
            ...
            >
              {orders.map((row, index) => (
                ...
                >
                  {headers.map((col) => {
                    const value = col.key === "index" ? index + 1 : row[col.key as keyof PlanOrder];
