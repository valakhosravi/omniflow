...
// const transformErrorForGetErrorMessage = (
//   error: FetchBaseQueryError,
//   originalArgs: string | FetchArgs,
// ) => {
//   const url =
//     typeof originalArgs === "string" ? originalArgs : originalArgs.url;
      ...
      if (isRefreshing && refreshPromise) {
        ...
        try {
          ...
          if (refreshResult.data) {
            ...
            if (
              refreshData.ResponseCode === 103 ||
              refreshData.ResponseCode === 106
            ) {
              // Invalid refresh token, navigate to logout
              console.error(
                "Invalid refresh token:",
                refreshData.ResponseMessage,
              );
