...
import { Flash, ImportCurve } from "iconsax-reactjs";
    ...
    <div className="relative flex gap-x-3 bg-pagination-dropdown border border-primary-950/[.2] rounded-[20px] p-3">
      ...
      <div className="flex flex-col space-y-[7px]">
        ...
        <div className="flex gap-x-2">
          <Flash size={24} className="text-secondary-400" />
          <p
      ...
      <CustomButton
        ...
        buttonSize="md"
        className="absolute bottom-4 left-4 font-medium text-[14px]/[27px]"
        startContent={<ImportCurve className="size-[20px] text-primary-950" />}
      >
        دریافت فایل راهنما
      </CustomButton>
    </div>
