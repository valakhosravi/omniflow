...
import { useGetDevelopmentRequestDetailsV1Query, useGetDevelopmentTicketQuery } from "../../api/developmentApi";
...
export default function SubmitJiraTicketModal({
  ...
  const { data: developTicketDetail } = useGetDevelopmentRequestDetailsV1Query(
    Number(requestId)
  );
