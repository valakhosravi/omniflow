...
interface ReportDataGovernanceManagerReviewFormData {
  description: string;
}

export default function ReportDataGovernanceManagerReviewPage({
  requestId,
}: {
  requestId: string;
}) {
  ...
  const {} = useForm<ReportDataGovernanceManagerReviewFormData>({
    defaultValues: {
      description: "",
    },
    mode: "onChange",
  ...
  return (
    <TaskInboxLayout>
      ...
      <Modal
        ...
        hideCloseButton
      >
        <ModalContent className="!w-[600px] max-w-[746px] max-h-[613px]">
          ...
          <ModalBody className="px-[24px] py-0 space-y-4 ">
            ...
            <div className="border border-primary-950/[.1] rounded-[20px] px-5 py-4 h-[150px] ">
              <Autocomplete
                className="w-full"
                variant="bordered"
          ...
          <ModalFooter className="flex items-center justify-end gap-x-[16px] pt-5 pb-[20px] px-[24px] ">
            <CustomButton
              buttonSize="sm"
              buttonVariant="outline"
