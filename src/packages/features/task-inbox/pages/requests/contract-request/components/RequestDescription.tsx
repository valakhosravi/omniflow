...
const buttons = [
  <CustomButton buttonSize="sm" buttonVariant="outline">
    نیازمند اقدام درخواست‌دهنده
  </CustomButton>,
  <CustomButton buttonSize="sm" buttonVariant="outline" className="!text-trash">
    رد درخواست
  </CustomButton>,
  <CustomButton buttonSize="sm" buttonVariant="primary">
    تایید درخواست
  </CustomButton>,
];
