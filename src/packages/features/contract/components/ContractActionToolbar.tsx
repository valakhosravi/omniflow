...
import SaveTemplateModal, {
  SaveTemplateData,
} from "./lmc/modals/SaveTemplateModal";
import SaveTemplateWithFieldsModal, {
  SaveTemplateWithFieldsFormData,
} from "./lmc/modals/SaveTemplateWithFieldsModal";
import VariablesManager, { TemplateVariable } from "./lmc/VariablesManager";
          ...
          {!onSubmit && (
            <Button
              ...
              onPress={async () => {
                ...
                } else if (!isTemplatePage && templateFormData && onSaveAsTemplate) {
