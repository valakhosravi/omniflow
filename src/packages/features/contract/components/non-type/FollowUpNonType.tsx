...
import { toLocalDateShort, toLocalTimeShort } from "@/utils/dateFormatter";
  ...
  const onDownloadContract = async () => {
    ...
    try {
      ...
      const pdfRequest: RenderContractRequest = {
        ...
        approvalHistory: hasLmcAccess && approvalHistory?.Data ? approvalHistory.Data : undefined,
      };
    ...
    <div className="px-4 py-6">
      ...
      <div className="grid grid-cols-12 gap-4">
        <div className="col-span-8">
          <ContractAttachments attachments={contractData.Attachments || []} />
        ...
        <div className="col-span-4">
          {hasLmcAccess && approvalHistory?.Data && approvalHistory.Data.length > 0 && (
            <div className="border border-[#D8D9DF] p-4 rounded-[20px] mb-4">
