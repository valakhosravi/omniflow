...
import { ArrowLeft, Note, Trash, Refresh } from "iconsax-reactjs";
...
export default function Completion() {
  ...
  const handlePreview = () => {
    router.push(`/contract/non-type/complete/preview?categoryId=${categoryId}`);
  };
