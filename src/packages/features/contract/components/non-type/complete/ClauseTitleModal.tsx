...
import { addClause } from "../../../slice/NonTypeContractDataSlice";
...
import { useUpdateClauseMutation } from "../../../api/contractApi";
import {
  BaseQueryFn,
  FetchArgs,
  FetchBaseQueryError,
...
export default function ClauseTitleModal({
  ...
  const [updateClause, { data: response, isLoading: isUpdating }] =
