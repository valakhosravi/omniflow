...
import { Edit2, Trash, Add, More, MessageAdd1, MessageText1 } from "iconsax-reactjs";
import CustomButton from "@/ui/Button";
import { Tooltip } from "@/ui/NextUi";
import { useSortable } from "@dnd-kit/sortable";
import { CSS } from "@dnd-kit/utilities";
import { TermSectionProps, DragHandleProps } from "../types/ContractReviewTypes";
                        ...
                        {hasAccessToEdit && onDeleteSubClause && (
                          ...
                          >
                            <CustomButton
                              ...
                              iconOnly
                              onPress={() =>
                                onDeleteSubClause(subClause, Number(term.TermId))
                              }
