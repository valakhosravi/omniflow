...
import { useGetContractDepartmentsQuery } from "../../api/contractApi";
...
export default function ContractReview({
  ...
  const isTaskInboxPage = pathname?.startsWith("/task-inbox") ?? false;
                ...
                <div className="flex justify-between items-center gap-2 mb-1 flex-wrap">
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    {canReply && !isReplyInputActive && (
                      <button
                        onClick={() =>
                          toggleReplyInput(comment.id, entityType, entityId)
                        }
...
function TermSection({
  ...
  comments,
  activeCommentInputs,
  commentTexts: _commentTexts,
  onToggleCommentInput,
  onAddComment,
  onCancelComment,
  setCommentTexts: _setCommentTexts,
  cluaseSortOrder,
  renderCommentThread,
  renderCommentInput,
  onEditTerm,
