...
import LmcEditTermModal from "../components/lmc/LmcEditTermModal";
import LmcEditSubClauseModal from "../components/lmc/LmcEditSubClauseModal";
import LmcAddClauseModal from "../components/lmc/LmcAddClauseModal";
import LmcAddTermModal from "../components/lmc/LmcAddTermModal";
import LmcAddSubClauseModal from "../components/lmc/LmcAddSubClauseModal";
import ClauseTitleModal from "../components/non-type/complete/ClauseTitleModal";
...
import PreviewNonTypeContractReport from "../components/non-type/PreviewNonTypeContractReport";
import { Modal, ModalContent, ModalHeader, ModalBody } from "@heroui/react";
import { DocumentText } from "iconsax-reactjs";
import Description from "../../task-inbox/pages/requests/contract-request/components/Description";
...
import { setContractData } from "../slice/LmcDataSlice";
...
import { RenderContractRequest, SignatureSettings } from "@/app/api/contract/render/types";
...
export default function LmcNonTypeForm({
  ...
  const handleAddComment = async (payload: {
    ...
    try {
      ...
      const entityIds = payload.entityIds || (payload.entityId ? [payload.entityId] : []);
  ...
  const onPreviewRequestClick = useCallback(async () => {
    ...
    try {
      ...
      const extractSignatureSettings = (): SignatureSettings => {
        ...
        return {
          needsSignature: settingsMap.needsSignature === "true" || settingsMap.needsSignature === "1",
          signerCompanyName: settingsMap.signerCompanyName || "",
          signerPerson: settingsMap.signerPerson || "",
          signerOrganizationPosition: settingsMap.signerOrganizationPosition || "",
          signaturePlacement: (settingsMap.signaturePlacement as "endOfContract" | "endOfEachPage") || "endOfContract",
        };
      };
      ...
      const convertClauses = (clauses: ContractClauseDetails[]): RenderContractRequest["ContractClauses"] => {
