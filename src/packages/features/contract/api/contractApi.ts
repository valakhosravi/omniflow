...
interface ContractFieldValuesByContractId {
  ContractFieldDetails: ContractFieldValue[];
...
export const contractApi = createApi({
  ...
  tagTypes: ["Contract", "Clause", "Term", "SubClause", "TermAssignee", "ContractAssignee"],
  endpoints: (builder) => ({
    // Existing endpoints
    ...
    >({
      ...
      providesTags: (result, error, id) => [{ type: "Clause", id }],
    }),
    ...
    >({
      ...
      providesTags: (result, error, id) => [{ type: "SubClause", id }],
    }),
    ...
    >({
      ...
      providesTags: (result, error, id) => [{ type: "TermAssignee", id }],
    }),
    getTermLibrariesByCategotyId: builder.query<
      GeneralResponse<getTermLibraryByCategoryId[]>,
      number
    >({
      query: (id) => ({
        url: `/v2/Contract/BasicInfo/Generation/GetTermLibrariesByCategotyId/${id}`,
        method: "GET",
      }),
    }),
    ...
    >({
      ...
      providesTags: (result, error, id) => [{ type: "ContractAssignee", id }],
    }),
    ...
    deleteSubCategoryTemplate: builder.mutation<
      GeneralResponse<null>,
      number
    >({
      query: (subCategoryId) => ({
    ...
    deleteBySubCategoryId: builder.mutation<
      GeneralResponse<null>,
      number
    >({
      query: (subCategoryId) => ({
