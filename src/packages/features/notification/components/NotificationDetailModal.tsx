...
import {
  useGetAllUserNotifionQuery,
  useUpdateIsReadMutation,
} from "../../task-inbox/api/NotificationApi";
import { toJalaliDateTime } from "../../task-inbox/utils/dateFormatter";
import { useEffect, useMemo } from "react";
import DOMPurify from "dompurify";
import { getTypeColor } from "../types/notifColors";
...
export default function NotificationDetailModal({
  ...
  const { refetch: refetchDropDown } = useGetAllUserNotifionQuery(false);
  const { refetch } = useGetAllUserNotifionQuery();
