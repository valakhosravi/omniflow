...
import FinancialAdditionalDescription from "./FinancialAdditionalDescription";
...
export default function FinancialDescription({
  invoiceDetails,
  refetch,
  requestStatus,
  requestId,
}: FinancialDescriptionProps) {
  ...
  return (
    <div className="col-span-8 border border-primary-950/[.1] rounded-[20px] p-4 space-y-[24px] mb-4">
      ...
      <InvoiceDetail
        ...
        isLong={isLong}
      />
      <FinancialAdditionalDescription
