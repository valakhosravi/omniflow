...
import DeputyAdditionalDescription from "./DeputyAdditionalDescription";
...
interface DeputyDescriptionProps {
  requestId?: string;
...
export default function DeputyDescription({
  invoiceDetails,
  requestId,
}: DeputyDescriptionProps) {
