...
interface FinancialAdditionalDescriptionProps {
  title: string;
...
export default function FinancialAdditionalDescription({
  title,
  invoiceDetails,
}: FinancialAdditionalDescriptionProps) {
